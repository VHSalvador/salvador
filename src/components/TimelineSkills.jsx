                    ...
                    <div style={styles.column}>
                        ...
                        <div style={styles.skillGroup}>
                            <h3 style={styles.skillHeader}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={styles.icon} aria-hidden="true">
...
const styles = {
    // grid styles moved to .grid-auto-fit
    header: {
        marginBottom: '2rem',
    },
    // Timeline Styles
    ...
    icon: {
        color: 'var(--color-blue-dark)', // Or a lighter shade if desired
        opacity: 0.8,
    },
    list: {
